...
def evaluate_census(
    ...
    pth_name: str = 'census-margin-0.764-feasibility-192.0-validity-29.0-epoch-25-fcx-binary.pth'
) -> dict:
    """
    Compute evaluation metrics for the Census dataset.
    ...
    res[dataset_name]['const-score'] = compute_eval_metrics(
        ...
        pred_model, vae_test_dataset, d,
        normalise_weights, mad_feature_weights,
        div_case, 2, sample_range, 'census-binary-feasibility-score'
    )
    ...
    res[dataset_name]['LOF'] = compute_eval_metrics(
        ...
        pred_model, vae_test_dataset, d,
        normalise_weights, mad_feature_weights,
        div_case, 7, sample_range, 'census-binary-lof', prefix_name=prefix_name
    )
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pth_name',       type=str, default='census-margin-0.764-feasibility-192.0-validity-29.0-epoch-25-fcx-binary.pth')
