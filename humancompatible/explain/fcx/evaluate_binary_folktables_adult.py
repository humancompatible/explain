...
def evaluate_folktables_adult(
    base_data_dir: str = 'data/',
    base_model_dir: str = 'models/',
    dataset_name: str = 'folktables_adult',
    pth_name: str = 'folktables_adult-margin-0.344-feasibility-147.0-validity-76.0-epoch-25-fcx-binary.pth'
) -> dict:
    """
    Compute evaluation metrics for the Folktables Adult dataset.
    ...
    res[dataset_name]['const-score'] = compute_eval_metrics_adult(
        ...
        pred_model, vae_test_dataset, d,
        normalise_weights, mad_feature_weights,
        div_case, 2, sample_range, f'{dataset_name}-binary-feasibility-score'
    )
    ...
    res[dataset_name]['LOF'] = compute_eval_metrics_adult(
        ...
        pred_model, vae_test_dataset, d,
        normalise_weights, mad_feature_weights,
        div_case, 7, sample_range, f'{dataset_name}-binary-lof-score',
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pth_name',       type=str, default='folktables_adult-margin-0.344-feasibility-147.0-validity-76.0-epoch-25-fcx-binary.pth')
    args = parser.parse_args()

    metrics = evaluate_folktables_adult(
